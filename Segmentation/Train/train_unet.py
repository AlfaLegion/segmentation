...
def train(train_data,test_data,save_model,num_epoch,batch_size,lr,momentum,treshold_f1_class_object=0.85):
    ...
    opt_sheduler=torch.optim.lr_scheduler.StepLR(optimizer,step_size=10,gamma=0.7)
    ...
    for epoch in range(num_epoch):
        ...
        #dice_c0,dice_c1,dice_c2=F1_score_check(model,dataLoaderTest)
    ...
    convertModel(model,save_model,img_size)
...
if __name__=="__main__":
    ...
    train(r'D:\datasets\data-science-bowl-2018\wich_border_2\stage1_train',
          r'D:\datasets\data-science-bowl-2018\wich_border_2\test',
          './TheBestModels/d2/UNetTransformDws/UNetDWS.pt',
          num_epoch=1,batch_size=21,lr=0.0115,momentum=0.95,treshold_f1_class_object=0.01)
