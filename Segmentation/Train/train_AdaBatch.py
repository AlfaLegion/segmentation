...
def trainUNet(train_data,test_data,save_model_name,num_epoch,batch_size,lr,momentum,betta_inc_bs,gamma_decay_lr,treshold_f1_class_object=0.85):
...
if __name__=="__main__":
    ...
    trainUNet(r'D:\datasets\data-science-bowl-2018\wich_border_2\stage1_train',
          ...
          "./TheBestModels/d2/AdaBatch/AB_UNetss.pt",
          num_epoch=1,batch_size=6,lr=0.0115,momentum=0.95,betta_inc_bs=2,gamma_decay_lr=0.7,treshold_f1_class_object=0.85)
   # visdom_exmpl()
